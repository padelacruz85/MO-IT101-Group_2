						    ...
						    //COMPUTE GROSS SALARY
						     gross_Salary = total_time * Double.parseDouble(row_data[11]);						 							 
						        System.out.println("""
						                ...
						                Gross Wage: PHP%s
						                ------------------------------------------
						                """.formatted(row_data[0].strip(),row_data[1],row_data[2], calcFormat.format(Double.parseDouble(row_data[11])), total_time, calcFormat.format(gross_Salary)));passFail=1;}
